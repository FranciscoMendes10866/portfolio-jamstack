  ...
  <div class="index">
    ...
    <section class="bg-gray-300 py-20 md:py-32">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mt-10">
          <div>
            <h1 class="ml-4 md:ml-0 text-2xl md:text-4xl font-bold tracking-wide">Profile</h1>
          </div>
          <div>
            <p
            ...
            <p class="ml-4 md:ml-0 text-md md:text-lg font-normal tracking-wide leading-loose mt-8">
    ...
    <section class="bg-gray-200 py-20 md:py-32">
      <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div>
            <h1 class="ml-4 md:ml-0 text-2xl md:text-4xl font-bold tracking-wide">Tech stack</h1>
          </div>
          <div>
            <p
              class="mt-4 md:mt-0 ml-4 md:ml-0 text-md md:text-lg font-normal tracking-wide leading-loose"
    ...
    <section class="bg-white py-16 md:py-20">
      <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div>
            <h1 class="ml-4 md:ml0 text-2xl md:text-4xl font-bold tracking-wide">Network</h1>
          </div>
          <div>
            <p
            ...
            <p class="mt-8 ml-4 md:ml0 text-md md:text-lg font-normal tracking-wide leading-loose">
              <a
